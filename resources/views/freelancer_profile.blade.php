            ...
            <div class="white-box">
                <div class="user-bg"> <img width="100%" alt="user" src="../plugins/images/large/img1.jpg">
                    <div class="overlay-box">
                        <div class="user-content">
                            <a href="javascript:void(0)"><img src="{{ url('img/image_freelancer/'.$freelancer->freelancer_photo) }}" class="thumb-lg img-circle" alt="img"></a>
                ...
                <div class="user-btm-box">
                    <div class="col-md-6 col-sm-6 text-center">
                        <p class="text-purple"><i class="fa fa-product-hunt"></i> Freelancer Point</p>
                        <h1>{{ $freelancer->freelancer_point }}</h1> </div>
                    <div class="col-md-6 col-sm-6 text-center">
                        <p class="text-blue"><i class="fa fa-check-circle"></i> Freelancer Status</p>
                        <h1>{{ $freelancer->freelancer_status == 0 ? $freelancer->freelancer_status = 'Non-Active' : $freelancer->freelancer_status = 'Active' }}</h1> </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-pane" id="profile">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6"> <strong>Location</strong>
                                <br>
                                <p class="text-muted">{{ $freelancer->freelancer_location }}</p>
                            </div>
                        </div>
                        <hr>
                        <p class="m-t-30">
                    ...
                    <div class="tab-pane" id="settings">
                        <form class="form-horizontal form-material">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="{{ Auth::user()->name }}" class="form-control form-control-line" disabled> </div>
                            </div>
                            <div class="form-group">
