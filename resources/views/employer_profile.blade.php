            ...
            <div class="white-box">
                <div class="user-bg"> <img width="100%" alt="user" src="../plugins/images/large/img1.jpg">
                    <div class="overlay-box">
                        <div class="user-content">
                            <a href="javascript:void(0)"><img src="{{ url('img/image_employer/'.$employer->employer_photo) }}" class="thumb-lg img-circle" alt="img"></a>
                ...
                <div class="user-btm-box">
                    <div class="col-md-6 col-sm-6 text-center">
                        <p class="text-purple"><i class="fa fa-product-hunt"></i> Employer Point</p>
                        <h1>15</h1> </div>
                    <div class="col-md-6 col-sm-6 text-center">
                        <p class="text-blue"><i class="fa fa-check-circle"></i> Employer Status</p>
                        <h1>{{ $employer->employer_status == 0 ? $employer->employer_status = 'Non-Active' : $employer->employer_status = 'Active' }}</h1> </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-pane" id="profile">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-6"> <strong>Location</strong>
                                <br>
                                <p class="text-muted">{{ $employer->employer_location }}</p>
                            </div>
                        </div>
                        <hr>
                        <p class="m-t-30">
                        {{ $employer->long_description }}
                        </p>
